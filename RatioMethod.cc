...
int main(){
  ...
  for (int i(0); i < (N_Pseudo_Exp); i++){                      // Loop over number of pseudo exp
    ...
    ostringstream conv;
    conv << i;
    string name1 = "PseudoA_Fast_Osc_" + conv.str();
    string name2 = "PseudoB_Fast_Osc_" + conv.str();
    string name3 = "PseudoC_Fast_Osc_" + conv.str();
    string name4 = "PseudoD_Fast_Osc_" + conv.str();
